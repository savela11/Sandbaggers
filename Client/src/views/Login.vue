...
export default defineComponent({
  name: "Login",
  components: {
    BaseInput: defineAsyncComponent(() => import("@/components/forms/BaseInput.vue"))
  },
  setup(props: any) {
  ...
  <div class="container container--login">
    ...
    <div class="section section--bottom">
      ...
      <div class="container container--front">
        <form class="form">
          <div class="field">
            <BaseInput v-bind="{label: 'Username', color: 'primary'}" v-model="loginForm.username"/>
          </div>
          <div class="field">
            <BaseInput v-bind="{label: 'Password', color: 'primary', inputType: 'password'}" v-model="loginForm.password"/>
          </div>
          <div class="field">
            <button class="btn btn--submit" @click.prevent.stop="Login">Login</button>
          </div>
        </form>
      </div>
    </div>
